...
def handler_download_file(file_id: str, bucket_name: str, key_main: str) -> ResponseData:
    try:
        response_download = download_file_psql(file_id, bucket_name, key_main)
...
def clean_up_task(directory):
    clear_folders_and_zips(directory, True)
